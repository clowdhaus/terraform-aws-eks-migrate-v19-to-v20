...
2. Change the source of your module to point to this module. Here we are using a git hash since this module will not be have any releases nor be published on the Terraform registry
    ...
    -  version = "~> 19.21"
    +  source  = "git@github.com:clowdhaus/terraform-aws-eks-v20-migrate.git?ref=933e800500c7fb6c7420996dd5021f8975d86192"
    }
    ```
...
| Name | Version |
|------|---------|
| <a name="provider_aws"></a> [aws](#provider\_aws) | >= 5.34, < 6.0 |
